codedWater_onOff1000<-Calculate_GraphTheory(dataList = "/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/onOffGroupList.txt",nEdgesOrThreshold = getEdgesFromPercent(10:50,116),analysisType = "group",comparison = T,threshType = "positive",edgeType = "partial",structuralData = T,numberPermutations = 10000,brainWide = T)
reformPermData<-listToMatrixByRow(codedWater_onOff1000[[7]])
reformDiffBW<-metaListRearrange(codedWater_onOff1000[[5]])
...
abindGroupDiff<-abind(codedWater_onOff1000[[4]],along = 3)
...
groupDiffBW<-codedWater_onOff1000[[4]]
...
saveRDS(permTestNewBWneg,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/onOffPermTestBWneg")
saveRDS(avgSMRG1M,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/onMedsAvg")
saveRDS(avgSMRG2M,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/offMedsAvg")
onConPermTestBWneg<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/onConPermTestBWneg")
offConPermTestBWneg<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/OffConPermTestBWneg")
onOffPermTestBWneg<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/onOffPermTestBWneg")
OnData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/onMedsAvg")
ConData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/conAvg")
OffData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/offMedsAvg")
