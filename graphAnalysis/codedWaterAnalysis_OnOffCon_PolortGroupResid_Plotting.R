require(ggplot2)
OnGroupData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConPolortGroupResid10000_On")
ConGroupData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConPolortGroupResid10000_Con")
...
onConContrast<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConPolortGroupResid10000")
onConGraphData<-onConContrast[[8]]
remove(onConContrast)
OffConContrast<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_offConPolortGroupResid10000")
