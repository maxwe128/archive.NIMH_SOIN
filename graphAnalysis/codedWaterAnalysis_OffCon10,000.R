codedWater_OffCon10000<-Calculate_GraphTheory(dataList = "/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/offConList",nEdgesOrThreshold = getEdgesFromPercent(10:50,116),analysisType = "group",comparison = T,threshType = "positive",edgeType = "partial",structuralData = T,numberPermutations = 10000,brainWide = T,pairedPerm=F,outputDirectory = "/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/offConWD/")reformPermData<-listToMatrixByRow(codedWater_OffCon1000[[7]])
...
saveRDS(codedWater_OffCon10000,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000")
saveRDS(group1IgraphMeasures,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000_group1")
saveRDS(group2IgraphMeasures,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000_group2")
codedWater_OffCon10000<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000")
group1IgraphMeasures<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000_group1")
group2IgraphMeasures<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_OffCon10,000_group2")
reformDiffBW<-metaListRearrange(codedWater_OffCon10000[[5]])
...
abindGroupDiff<-abind(codedWater_OffCon10000[[4]],along = 3)
...
groupDiffBW<-codedWater_OffCon10000[[4]]
...
saveRDS(permTestNewBWneg,"/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/OffConPermTestBWneg10,000")
