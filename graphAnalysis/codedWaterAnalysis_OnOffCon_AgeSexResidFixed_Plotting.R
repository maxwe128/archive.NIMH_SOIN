require(ggplot2)
OnGroupData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConResidAgeSexFixed10000_On")
ConGroupData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConResidAgeSexFixed10000_Con")
OffGroupData<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onOffResidAgeSexFixed10000_Off")
onOffContrast<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onOffResidAgeSexFixed10000")
onOffGraphData<-onOffContrast[[8]]
remove(onOffContrast)
onConContrast<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_onConResidAgeSexFixed10000")
onConGraphData<-onConContrast[[8]]
remove(onConContrast)
OffConContrast<-readRDS("/x/wmn18/elliottml/GraphTheoryAnalyses/codedWaterAnalysis/savedObjects/codedWater_offConResidAgeSexFixed10000")
