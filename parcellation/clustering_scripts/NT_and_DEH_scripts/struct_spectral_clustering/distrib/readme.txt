...
================================
-struct_spectral_clustering 
-run_struct_spectral_clustering.sh (shell script for temporarily setting environment 
                                    variables and executing the application)
   -to run the shell script, type
   
       ./run_struct_spectral_clustering.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v80, run the shell script as:
       ...
       ./run_struct_spectral_clustering.sh /mathworks/home/application/v80
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_struct_spectral_clustering.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_struct_spectral_clustering.sh 
