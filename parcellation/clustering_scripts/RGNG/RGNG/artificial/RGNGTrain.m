function [optcenter,actcenter,allmdlvalue] = RGNGTrain(dataset,center,prenumnode,realcenternum)
...
[optcenter,actcenter,allmdlvalue]=TrainRGNG(RGNG,realcenternum);