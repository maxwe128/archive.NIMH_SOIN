function [result]=RGNGrun(dataset,inicenter,realcenter,noisenum,prenode);
...
[optcenter,actcenter,mdlvalue] = RGNGTrain(dataset,inicenter,prenode,size(realcenter,1));
